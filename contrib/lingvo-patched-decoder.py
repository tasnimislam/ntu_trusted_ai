...
class AsrDecoderBase(base_decoder.BaseBeamSearchDecoder):
  ...
  def ComputeLoss(self, theta, predictions, targets):
    ...
    Args:
      theta: A NestedMap object containing weights_preliminary_classifier' values of this
  ...
  def ComputePredictions(self, theta, encoder_outputs, targets):
    ...
    Args:
      theta: A NestedMap object containing weights_preliminary_classifier values of this layer and its
        child layers.
      encoder_outputs: a NestedMap computed by encoder.
      targets: A dict of string to tensors representing the targets one is
        trying to predict. Each tensor in targets is of shape [batch, time].
    ...
    if 'weights_preliminary_classifier' not in targets and 'paddings' in targets:
...
class AsrDecoder(AsrDecoderBase):
  ...
  def _ComputeAttention(self,
    ...
    Args:
      theta: A NestedMap object containing weights_preliminary_classifier for the attention layers.
